    ...
    <main>
      <div className="min-h-screen bg-gradient-to-br from-blue-400 to-indigo-700 flex flex-col items-center justify-center text-white p-6">
        ...
        <div className="mt-12 flex flex-col sm:flex-row gap-4">
          ...
          <Link href="#how-it-works" className="bg-transparent border-2 border-white text-white px-8 py-4 rounded-full text-lg font-semibold hover:bg-white/20 transition-colors">
              Como Funciona?
          </Link>
        </div>
        ...
        <footer className="mt-20 text-blue-300 text-sm">
          &copy; {new Date().getFullYear()} Meu Info ID. Todos os direitos reservados.
        </footer>
      </div>
    </main>
  );
